...
- Color variables and RGB format
- Dark mode setup
...
Colors use RBG: `--primary: rgb(0 0 0)`, `--primary: rgb(255 122 127 / 0.2)`.
...
:root {
  --warning: rgb(0 0 84);
  --warning-foreground: rgb(0 0 46);
}
.dark {
  --warning: rgb(0 0 46);
  --warning-foreground: rgb(0 0 95);
}
```
  ...
  theme: {
    extend: {
      colors: {
        ...
        "warning-foreground":
          "rgb(var(--warning-foreground) / <alpha-value>)",
      },
    },
  },
}
